...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    if (queries_json.contains("events") && queries_json["events"].is_array())
    {
        for (auto &query : queries_json["events"]) // Use &query to pass modifiable json
        {
            ...
            */
            ...
            json result = qp.process_query(query);
